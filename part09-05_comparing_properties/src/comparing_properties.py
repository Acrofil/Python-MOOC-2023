...
class RealProperty:
    ...
    def price_difference(self, compared_to):
        ...
        first_property = self.price_per_sqm * self.square_metres
        second_property = compared_to.price_per_sqm * compared_to.square_metres

        return abs(first_property - second_property)
