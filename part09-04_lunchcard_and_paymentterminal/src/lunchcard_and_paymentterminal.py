...
class PaymentTerminal:
    ...
    def eat_lunch_lunchcard(self, card: LunchCard):
        ...
        condition = LunchCard.subtract_from_balance(card, 2.50)
    ...
    def eat_special_lunchcard(self, card: LunchCard):
        ...
        condition = LunchCard.subtract_from_balance(card, 4.30)
        ...
        #return LunchCard.subtract_from_balance(self, 4.30)
